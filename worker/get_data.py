...
# 統計の一覧を取得
create_stat_list_of_db()

# 日付のフォルダ作成
root_dir = Path(f"resource")
root_dir.mkdir(parents=True, exist_ok = True)

# テーブルの情報を取得
table_dest = root_dir / "table.csv"
create_table_list(current_date
                  ).to_csv(table_dest, index = False, quoting=csv.QUOTE_ALL)
